...
// Pasos manuales para aplicar la migración de notificaciones

# Pasos para aplicar la migración de notificaciones

## Paso 1: Crear las tablas

Ejecuta las siguientes sentencias SQL en tu editor SQL de Supabase:
...
3. Copia y pega cada sección de arriba en orden
4. Ejecuta cada sección haciendo clic en "RUN"
5. Verifica que no haya errores

¡Después de aplicar estas migraciones, el sistema de notificaciones debería funcionar correctamente!