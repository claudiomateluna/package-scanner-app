-- CORRECCIÓN FINAL DE LA LÓGICA DE DESTINATARIOS
-- Se actualiza la función para que consulte la tabla `public.profiles` en lugar de `auth.users` para encontrar los roles y locales de los usuarios.
...
BEGIN
    ...
    -- CORRECCIÓN: La consulta ahora apunta a `public.profiles` para obtener el rol y el local.
    ...
    WHERE 
        ...
        (
            ...
            AND
            p.nombre_local = ticket_record.nombre_local
        )
