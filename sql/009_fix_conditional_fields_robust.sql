-- CORRECCIÓN FINAL Y ROBUSTA: Manejo de campos específicos de tabla en el trigger
-- Se usan variables temporales asignadas condicionalmente para evitar acceder a campos inexistentes en `ticket_record`.
...
BEGIN
    ...
    -- Asignar valores a las variables temporales condicionalmente
    IF TG_TABLE_NAME = 'faltantes' THEN
        v_delivery_note := ticket_record.delivery_note;
        v_olpn := ticket_record.olpn;
        v_tipo_reporte := ticket_record.tipo_reporte;
