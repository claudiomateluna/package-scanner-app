-- CORRECCIÓN FINAL DE LA FUNCIÓN DE TRIGGER
-- Se cambia el nombre de la variable `dedup_key` a `v_dedup_key` para resolver la ambigüedad.
...
DECLARE
    ...
    v_dedup_key TEXT; -- Variable renombrada
